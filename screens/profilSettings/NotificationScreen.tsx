...
export default function NotificationScreen() {
	...
	//Couleur de la poignée activer
	const secondthumbColorOn =
		Platform.OS === "android" ? "#ECEEF1" : "#FDDBD8";
	//Couleur de la poignée desactiver
	const secondthumbColorOff =
		Platform.OS === "android" ? "#43567A" : "#FDDBD8";
	//Couleur du tracé derrière la poignée activer
	const secondtrackColorOn =
		Platform.OS === "android" ? "#43567A" : "#FDDBD8";
	//Couleur du tracé derrière la poignée desactiver
	const secondtrackColorOff =
		Platform.OS === "android" ? "#ECEEF1" : "#FDDBD8";
