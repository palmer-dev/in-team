...
export default function HelpScreen() {
	...
	const [messagesType, setMessagesType] = useState<{label:String,value:String}[]|undefined>([
	...
	const [messagesTypeSelected, setMessagesTypeSelected] = useState<{label:String,value:String}|undefined>();
	...
	return (
		<SafeAreaView>
			...
			<View style={{backgroundColor: "transparent"}}>
				<Text style={{fontWeight: "bold", fontSize: 18}}>Un problème ?</Text>
				<Text style={{fontWeight: "bold", fontSize: 18}}>Une demande ?</Text>
