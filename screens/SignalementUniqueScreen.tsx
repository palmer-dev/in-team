  ...
  return (
    <ScrollView>
      <View style={styles.container}>
        ...
        <Text
          style={signalement.etat === "fait" ? styles.subtitle : styles.etat}
        >
          État: {signalement.etat}
        </Text>
        {signalement.etat !== "fait" && signalement.photo_probleme && (
          <View>
            <View style={styles.images}>
              {signalement.photo_probleme.map((image) => (
                <TouchableWithoutFeedback
                  key={image}
                  onPress={() =>
                ...
                >
                  <View>
                    <Image
                      style={styles.image}
                      source={{
                        uri: `https://lab-rey.fr:444/images/${image}`,
                      }}
                    />
                  </View>
                </TouchableWithoutFeedback>
